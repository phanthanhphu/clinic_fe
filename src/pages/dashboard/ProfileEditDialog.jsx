...
const ProfileEditDialog = ({ open, onClose, onUpdate, user }) => {
  ...
  const toServerPath = (urlWithQuery) => {
    ...
    return noQuery.replace(`${API_BASE_URL}/`, '/').replace(API_BASE_URL, '');
  };
  ...
  const paperSx = {
    ...
    background: theme.palette.mode === 'dark' ? alpha(theme.palette.background.paper, 0.72) : alpha('#FFFFFF', 0.9),
  ...
  const imageActionLabel = newImage ? 'New upload' : removedImageUrl ? 'Remove current' : 'Keep current';
    ...
    <>
      ...
      >
        ...
        >
          <Stack direction="row" alignItems="center" justifyContent="space-between" spacing={2}>
            <Box>
              ...
              <Typography sx={{ opacity: 0.9, mt: 0.4, fontSize: 13 }}>Update profile details and avatar</Typography>
            </Box>
          ...
          <Stack spacing={2.2}>
            ...
            >
              <Box sx={{ ...subtleCardSx, p: 2 }}>
                <Stack spacing={1.6} alignItems="center">
                  ...
                  <Box sx={{ textAlign: 'center' }}>
                    <Typography sx={{ fontWeight: 800 }}>{formData.username || 'Unknown User'}</Typography>

                    <Typography sx={{ color: 'text.secondary', fontSize: 13 }}>{formData.email || '—'}</Typography>
                  </Box>
                  ...
                  <Typography sx={{ color: 'text.secondary', fontSize: 12, mt: 0.5 }}>JPG/PNG • max 5MB</Typography>
              ...
              <Box sx={{ ...subtleCardSx, p: 2 }}>
                <Stack spacing={2}>
                  <Box>
                    <Typography sx={{ fontWeight: 900, letterSpacing: 0.3 }}>Account</Typography>

                    <Typography sx={{ color: 'text.secondary', fontSize: 13, mt: 0.3 }}>Basic profile information</Typography>
                  </Box>
                  ...
                  <Box>
                    <Typography sx={{ fontWeight: 900, letterSpacing: 0.3 }}>Contact</Typography>

                    <Typography sx={{ color: 'text.secondary', fontSize: 13, mt: 0.3 }}>Public profile and contact info</Typography>
                  </Box>
                  ...
                  >
                    <Typography sx={{ fontSize: 12.5, color: 'text.secondary' }}>
                      <b>Note:</b> Email is locked and cannot be changed from this form. Uploading a new image automatically marks the old
                      image for deletion via <code>imageToDelete</code>, matching your existing logic.
                    </Typography>
                  </Box>
                </Stack>
              </Box>
        ...
        <DialogActions sx={{ px: { xs: 2, sm: 2.5 }, py: 2, gap: 1 }}>
          ...
          <Button onClick={handleSubmit} disabled={saving} variant="contained" sx={gradientBtnSx}>
