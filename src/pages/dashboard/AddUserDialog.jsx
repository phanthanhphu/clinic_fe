...
const AddUserDialog = ({ open, onClose, onAdd }) => {
  ...
  const paperSx = useMemo(
    () => ({
      ...
      background: theme.palette.mode === 'dark' ? alpha(theme.palette.background.paper, 0.72) : alpha('#FFFFFF', 0.92),
      ...
      >
        <DialogTitle sx={headerSx}>
          <Stack direction="row" alignItems="center" justifyContent="space-between" spacing={2}>
            <Box>
              ...
              <Typography sx={{ opacity: 0.9, mt: 0.4, fontSize: 13 }}>Create a user with role, department and profile image</Typography>
            </Box>
        ...
        <DialogContent sx={{ p: { xs: 2, sm: 2.5 } }}>
          <Stack spacing={2}>
            <Box sx={{ ...subtleCardSx, p: 2 }}>
              ...
              >
                ...
                <FormControl fullWidth size="small" disabled={locked} sx={fieldSx}>
                  ...
                  <FormHelperText>Controls whether this user can approve notices, documents, both, or none.</FormHelperText>
                </FormControl>
                ...
                <FormControl fullWidth size="small" disabled={locked} sx={fieldSx}>
                  ...
                  <FormHelperText>Controls whether this user can add, edit, delete and show room bookings on Index Room.</FormHelperText>
                </FormControl>

                <FormControl fullWidth size="small" disabled={locked || loadingDepartments} sx={fieldSx} error={showDepartmentError}>
                  <InputLabel sx={{ fontWeight: 700 }}>Department</InputLabel>
                  <Select value={formData.departmentId} label="Department" onChange={handleChange('departmentId')}>
                  ...
                  <FormHelperText>
                    {showDepartmentError ? 'Department is required' : loadingDepartments ? 'Loading departments...' : ' '}
                  </FormHelperText>
                </FormControl>
            ...
            <Box sx={{ ...subtleCardSx, p: 2 }}>
              <Typography sx={{ fontWeight: 900, letterSpacing: 0.3 }}>Profile Image</Typography>
              <Typography sx={{ color: 'text.secondary', fontSize: 13, mt: 0.3 }}>Optional. JPG/PNG under 5MB.</Typography>

              <Divider sx={{ my: 1.6 }} />

              <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1.2} alignItems={{ xs: 'stretch', sm: 'center' }}>
                <Button variant="outlined" component="label" startIcon={<PhotoCamera />} disabled={locked} sx={outlineBtnSx}>
                  Select Image
