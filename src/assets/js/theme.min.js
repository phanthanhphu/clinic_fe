                ...
                l.each(function () {
                  t(this).hasClass('current')
                    ? (t(this).removeClass('current'),
                      t(this).wrap('<li class="paginate_item ' + i.paginationItemsClasses + ' active"></li>'))
        ...
        if (a) {
          ...
          t(e).on('click', a, function () {
            ...
            a.child.isShown()
              ...
              : (a.child(n.format(e.data('details'))).show(), e.addClass('opened'));
          });
        }
      },
      select: function (e, a) {
    ...
    t.HSCore.components.HSSelect2 = {
      ...
      singleMultiple: function (e, a) {
        ...
        let n = t(e).next('.select2').find('.select2-selection'),
          i =
            e.find(':selected').length > 0 ? s.singleMultiplePrefix + e.find(':selected').length + s.singleMultiplePostfix : s.placeholder;
      ...
      formatData: function (e) {
        var a,
          s = e;
        return s.element
          ? ((a = s.element.dataset.optionTemplate ? s.element.dataset.optionTemplate : '<span>' + s.text + '</span>'), t.parseHTML(a))
          : s.text;
      },
        ...
        if (e.length) {
          ...
          (i = t.extend(!0, s, i, n, a)),
            e.hasClass('js-step-form')
              ? t.validator.setDefaults({ ignore: ':hidden:not(.active select)' })
                      ...
                      yAxes: [
                        {
                          ticks: {
                            callback: function (t, e, a) {
                              ...
                              return (
                                s && t > 100 && (t = t < 1e6 ? t / 1e3 + 'k' : t / 1e6 + 'kk'),
                      ...
                      custom: function (t) {
                          ...
                          s.forEach(function (t) {
                            ...
                            n.forEach(function (e, a) {
                              ...
                              var s = e[0],
                                n = s,
                                o =
                                  t.labelColors[a].backgroundColor instanceof Object
                        ...
                        (a.style.opacity = 1),
                          i.options.tooltips.lineMode
                            ...
                            : (a.style.left = l.left + window.pageXOffset + t.caretX - a.offsetWidth / 2 - 3 + 'px'),
          ...
          var s = t(e),
            ...
            o = {
              beforeShow: function (e) {
                var a = t(e.$refs.bg[0]),
                  ...
                  n = e.current.opts.$orig[0].dataset.hsFancyboxOptions
                    ? JSON.parse(e.current.opts.$orig[0].dataset.hsFancyboxOptions)
                    : {},
              ...
              beforeClose: function (e) {
                ...
                s.overlayBlurBg;
                n && (a.removeClass(n.onShow).addClass(n.onHide), t('body').removeClass('fancybox-opened')),
          ...
          if (40 === e.which) {
            if ((e.preventDefault(), 0 == t(i.list).children('.active').length)) n = t(i.list).children().first().addClass('active');
              ...
              t(n).removeClass('active'),
                (n = a),
                t(i.list).height() < t(i.list).children('.active').position().top &&
                  t(i.list).scrollTop(t(i.list).children('.active').position().top + t(i.list).scrollTop());
            }
          } else if (38 === e.which) {
          ...
          return (
            r.on('showCalendar.daterangepicker', function (e) {
              (o.prevArrow || o.nextArrow) &&
                (t('.daterangepicker .prev').html(o.prevArrow), t('.daterangepicker .next').html(o.nextArrow));
            }),
            r
          );
        }
                  ...
                  for (var s = 0; s < i.secondary_val.steps.length; s++)
                    e.from >= i.secondary_val.steps[s] &&
                      ...
                      (t(i.secondary_target_el).is('input')
                        ? t(i.secondary_target_el).val(i.secondary_val.values[s])
                        : t(i.secondary_target_el).text(i.secondary_val.values[s]));
                }
              },
              onChange: function (e) {
                if (i.foreground_target_el) {
                ...
                if (
                  ...
                  for (var n = 0; n < i.secondary_val.steps.length; n++)
                    e.from >= i.secondary_val.steps[n] &&
                      ...
                      (t(i.secondary_target_el).is('input')
                        ? t(i.secondary_target_el).val(i.secondary_val.values[n])
                        : t(i.secondary_target_el).text(i.secondary_val.values[n]));
          ...
          return (
            i.result_min_target_el && 'single' === i.type && t(i.result_min_target_el).is('input')
              ...
              : (i.result_min_target_el ||
                  (i.result_max_target_el && 'double' === i.type && t(i.result_min_target_el).is('input')) ||
